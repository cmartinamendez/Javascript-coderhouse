...
let mixerCabanas = mixitup('.cabana__container', { 
    ...
    /* Link Active Cabaña */
    const linkCabana = documen.querySelectorAll('.cabana__item')

    function activeCabana() {
        linkCabana.forEach(l=> I.classList.remove('active-cabana'))
        this.classList.add('active-work')
    }
    linkCabana.forEach(l=> I.addEventListener("click", activeCabana))
